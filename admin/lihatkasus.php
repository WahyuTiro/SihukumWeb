        ...
        <div class="bd bd-gray-300 rounded table-responsive">
            ...
            <table width="97%" class="table table-hover table-sm mg-b-0">
                ...
                <tr class="tx-center">
                    ...
                    <td width="5%">
                        <a href="tolakkasus.php?id_kasus=<?php echo $kasus['id_kasus']; ?>" class="btn btn-danger active btn-with-icon" onClick="return confirm('Anda yakin akan menolak kasus ini?');">
                          <div class="ht-15 justify-content-between">
