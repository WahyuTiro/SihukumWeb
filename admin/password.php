...
?>
	...
	<div class="br-pagebody">
        <div class="br-section-wrapper">
         <div class="btn-demo">
         <form id="form" method="post" action="prosesgantipassword" enctype="multipart/form-data">
          <input class="form-control" type="hidden" name="id" value="<?php echo $_SESSION['user']['id']; ?>">
                <p>Password Lama</p>
                <p><input class="form-control" type="password" name="passwordl" style="font-size: 14px; color: gray;" placeholder="Masukkan password lama" required></p>
                <p>Password Baru</p>
                <p><input class="form-control" type="password" name="passwordb" style="font-size: 14px; color: gray;" placeholder="Masukkan password baru" required></p>
                <p>
                    <div class="row">
