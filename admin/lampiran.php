      ...
      $(document).ready(function() {
        $('#form').validate({
          ...
          messages: {
            ...
            departemen: {
              required: 'Departemen/jabatan harus diisi.'
            },
            foto: {
            ...
            hari: {
              required: 'Hari jadwal harus diisi.'
            },
            tgl_jadwal: {
              required: 'Tanggal jadwal harus diisi.'
            },
            passwordl: {
              required: 'Isi sesuai password lama.'
            },
            passwordb: {
              required: 'Isi sesuai password baru.'
            },
            username: {
