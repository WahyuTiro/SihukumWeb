        ...
        <div class="bd bd-gray-300 rounded table-responsive">
            ...
            <table width="97%" class="table table-hover mg-b-0">
                ...
                <tr class="tx-center">
                    ...
                    <td>
                      <a href="javascript:void(0)" class="btndeskrip btn btn-warning active tx-11 tx-spacing-1 tx-semibold tx-mont pd-y-12 pd-x-20" id='<?php echo  $kasus['id_kasus']; ?>'>Lihat Kasus</a>
                    </td>
                    <td>
                      <a href="javascript:void(0)" class="btnfoto btn btn-warning active tx-11 tx-spacing-1 tx-semibold tx-mont pd-y-12 pd-x-20" id='<?php echo  $kasus['id_kasus']; ?>'>Lihat Bukti</a>               
