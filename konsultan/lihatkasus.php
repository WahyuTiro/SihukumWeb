...
$querykontan = "SELECT * FROM jadwal where id_kontan='$id_kontan'";
$dpkontan = array();
$hasilkontan = mysqli_query($db, $querykontan);
while ($rowkontan = mysqli_fetch_assoc($hasilkontan)) {
$dpkontan[] = $rowkontan['id_kasus'];
}
$implode = implode("' OR id_kasus ='", $dpkontan);

$query = "SELECT * FROM kasus where id_kasus='$implode'";
        ...
        <div class="br-section-wrapper">
         <div class="btn-demo">
              <div class="bd bd-gray-300 rounded table-responsive">
                <table width="100%" class="table table-hover table-sm mg-b-0">
                <thead align="right">
                <tr>
